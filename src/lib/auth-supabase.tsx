...
// ============================================
// Set NEXT_PUBLIC_ENABLE_TEST_LOGIN=true in .env.local to enable
...
const TEST_USER = {
  ...
  user: {
    ...
    isAdmin: true, // Give test user admin access for full testing
  } as User,
};
...
export function AuthProvider({ children }: { children: React.ReactNode }) {
  ...
  const login = async (credentials: LoginCredentials) => {
    ...
    // Check for test credentials (local development only)
    if (TEST_LOGIN_ENABLED && 
      ...
      const mockSession = {
        ...
        user: {
          ...
          user_metadata: { username: TEST_USER.user.username },
          created_at: TEST_USER.user.createdAt,
          aud: 'authenticated',
          role: 'authenticated',
        },
